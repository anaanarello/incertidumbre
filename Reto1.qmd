...
$$
\mathbb{P}(S = \text{Mujer} \mid T \in \{\text{Privado, Público}\})
$$

$$
\mathbb{P}(S = \text{Hombre} \mid T \in \{\text{Privado, Público}\})
$$
...
- Pregunta 5.25: El automóvil que manejó el día de viaje, ¿qué holograma tiene?
